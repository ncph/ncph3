...
cagedownconvert() {
    ...
    ffmpeg -i "$1" -c:v h264 -tune film -preset faster -profile:v baseline -level 3.1 -vf scale=-2:480 -pix_fmt yuv420p -minrate 1000k -maxrate 1400k -bufsize 4500k -c:a mp3 -b:a 160k -ar 44100 -af loudnorm=I=-16:TP=-1.5:LRA=11 "$2"
}
