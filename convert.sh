...
cagedownconvert() {
    ...
    ffmpeg -i "$1" -c:v h264 -tune film -preset ultrafast -profile:v baseline -level 3.1 -vf scale=-2:480 -pix_fmt yuv420p -minrate 500k -maxrate 1000k -bufsize 4000k -c:a mp3 -b:a 128k -ar 44100 "$2"
}
