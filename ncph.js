...
var clips = [
  ...
  new Clip('snakeeyes-autograph'),
  new Clip('birdy-mammaries'),
  new Clip('tresspass-gems'),
  new Clip('leavinglas-drink'),
  new Clip('wicker-burned'),
  new Clip('nattres2-resolute'),
  new Clip('adaptation-voyeur'),
  new Clip('wildheart-oz'),
  new Clip('portofcall-lizard'),
  new Clip('next-incoming'),
  new Clip('ghostrider2-ride'),
  new Clip('vk-contract'),
  new Clip('bangkok-boats'),
  new Clip('nattres2-secret'),
  new Clip('moonstruck-bread'),
  new Clip('amos-cookhere'),
  new Clip('honeymoon-marryme'),
  new Clip('peggysue-sing'),
  new Clip('cityangels-wings'),
  new Clip('timetokill-croc'),
  new Clip('bestoftimes-speech'),
  new Clip('deadfall-stfu'),
  new Clip('vk-alphabet'),
  new Clip('wicker-dronemustdie'),
  new Clip('faceoff-newface'),
